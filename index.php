...
$men = <<<SQL
SELECT * FROM `items` WHERE `sex` = 0  AND `for_kids` = 0
SQL;
$result_men = mysqli_query($connect, $men);

$women = <<<SQL
SELECT * FROM `items` WHERE `sex` = 1  AND `for_kids` = 0
SQL;
$result_women = mysqli_query($connect, $women);

$kids = <<<SQL
SELECT * FROM `items` WHERE `for_kids` = 1
SQL;
$result_kids = mysqli_query($connect, $kids);
?>
                ...
                <div class="col-lg-12">
                    <div class="men-item-carousel">
                        <div class="owl-men-item owl-carousel">
                            <?php while($r = mysqli_fetch_assoc($result_men)){ ?>
                                <div class="item">
                                    <div class="thumb">
                                        <div class="hover-content">
                                            <ul>
                ...
                <div class="col-lg-12">
                    <div class="women-item-carousel">
                        <div class="owl-women-item owl-carousel">
                            <?php while($r = mysqli_fetch_assoc($result_women)){ ?>
                                <div class="item">
                                    <div class="thumb">
                                        <div class="hover-content">
                                            <ul>
                ...
                <div class="col-lg-12">
                    <div class="kid-item-carousel">
                        <div class="owl-kid-item owl-carousel">
                            <?php while($r = mysqli_fetch_assoc($result_kids)){?>
                                <div class="item">
                                    <div class="thumb">
                                        <div class="hover-content">
                                            <ul>
